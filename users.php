...
<body class="flex flex-col h-screen">
    ...
    ?>
    <div class="users flex-auto font-bold">
        ...
        <table class="border-collapse border-2 table-auto w-10/12 mx-auto text-center">
            <thead class="text-2xl bg-yellow-200" style="color: darkblue;">
                <tr>
                    <th class="w-1/9 border-2 th ">Customer ID</th>
                    <th class="w-1/3 border-2 th">Customer Name</th>
                    <th class="w-1/3 border-2 th">Customer Email</th>
                    <th class="w-2/9 border-2 th">Account Balance</th>
                </tr>
            </thead>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      <tr>
                          ...
                          <td class="border-2 td">'.$row["name"].'</td>
                          <td class="border-2 td">'.$row["email"].'</td>
                          <td class="border-2 td">&#8377; '.$row["currentBalance"].'.00</td>
                      </tr>
                      ';
                    }
                  } else {
