...
<body class="flex flex-col h-screen">
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($flag == true) {
                ...
                echo "<script type='text/javascript'>window.location.href = './transactions.php';</script>";
            }
        }
    ...
    <!-- Main content start -->
    <div class="transfer flex-auto flex flex-col md:flex-row lg:flex-row flex-wrap justify-around content-evenly">
